  ...
  var SHADERS = {
    ...
    gradient: {
      fragment: /* glsl */`
        ...
        void main() {
          vec2 uv = vUv;
          float n = noise(uv * 2.5 + vec2(uTime * 0.08, uTime * 0.05));
          float t = uTime * 0.25;
          float r = 0.45 + 0.35 * sin(uv.x * 3.14159 + t       + n * 1.5);
          float g = 0.20 + 0.20 * sin(uv.y * 3.14159 + t * 0.7 + n * 1.2);
          float b = 0.55 + 0.40 * sin((uv.x + uv.y) * 2.0 + t * 1.1 + n);
